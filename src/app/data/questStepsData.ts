 ...
 */
export const validateAptosAddress = (address: string): { isValid: boolean; message: string } => {
  ...
  if (!regex.test(address)) {
    return { 
      isValid: false, 
      message: 'Invalid Aptos address format. Must start with 0x followed by 64 hex characters' 
    };
  }
  ...
  '1': [
    {
      ...
      description: 'Connect your Petra, Martian, or other Aptos-compatible wallet to begin the quest.',
    ...
    },
    {
      ...
      description: 'Enter your Aptos wallet address to verify ownership and complete this step.',
    ...
    },
    {
      ...
      description: 'Add 10 APT to your wallet. You can get APT from exchanges like Binance, Coinbase, or OKX.',
    ...
    },
    {
      ...
      description: 'Exchange at least 1 APT for 10 USDT using Pontem Network or Liquid Swap on Aptos.',
    ...
    },
    {
      ...
      description: 'Add liquidity to an APT-USDT pool on a decentralized exchange to earn trading fees.',
    ...
    },
    {
      ...
      description: 'Stake at least 1 APT on a staking platform like Tortuga Finance to earn staking rewards.',
    ...
    },
    {
      id: '1-7',
      title: 'Mint an NFT',
      description: 'Create and mint your first NFT on Topaz or BlueMove marketplace on Aptos.',
    ...
    },
    {
      ...
      description: 'Register your own .apt domain name with Aptos Name Service (ANS).',
    ...
    },
    {
      id: '1-9',
      title: 'Use Bridge',
      description: 'Bridge at least 1 USDT from Aptos to another blockchain using LayerZero or Wormhole.',
