  ...
  const projects: Project[] = [
    {
      ...
      name: "AptoSwap",
      description:
        "Decentralized exchange built on the Aptos blockchain with auto-compounding yield farms.",
    ...
    },
    {
      ...
      name: "Pixel Worlds",
      description:
        "NFT-based metaverse game where players can build, trade and explore virtual lands.",
      logo: "/placeholder.jpg",
      category: "Gaming",
      questCount: 5,
      users: 3567,
    ...
    },
    {
      ...
      name: "TrustVault",
      description:
        "Multi-signature wallet solution with enhanced security features and social recovery.",
      logo: "/placeholder.jpg",
      category: "Security",
      questCount: 2,
      users: 876,
    ...
    },
    {
      ...
      name: "DataChain",
      description:
        "Decentralized data marketplace for secure data sharing and monetization.",
      logo: "/placeholder.jpg",
    ...
    },
    {
      ...
      name: "EcoFund",
      description:
        "Climate-focused fundraising platform using blockchain for transparency.",
      logo: "/placeholder.jpg",
