      ...
      <main className="flex-grow container mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8">
            Add your project to Quest Generator and create educational quests to
            engage with users.
          </p>
          ...
          {submitSuccess ? (
            ...
            <form
              ...
              className="bg-white dark:bg-dark-200 rounded-lg shadow-sm border border-gray-200 dark:border-dark-100 p-6"
            >
              {submitError && (
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Briefly describe your project and what users can learn from
                    your quests.
                  </p>
                </div>
