            ...
            <div className="lg:w-3/4">
              <div className="bg-white dark:bg-dark-200 rounded-lg border border-gray-200 dark:border-dark-100 p-6">
                {activeSection === 'getting-started' && (
                  <div>
                    ...
                    <p className="mb-4 text-gray-700 dark:text-gray-300">
                      Welcome to Quest Generator! This guide will help you get started with creating and managing educational crypto quests.
                    </p>
                    
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-6 mb-3">What are Quests?</h3>
                    <p className="mb-4 text-gray-700 dark:text-gray-300">
                      Quests are interactive learning experiences that guide users through specific tasks related to crypto projects.
                      Each quest consists of a series of steps that users complete to earn rewards.
                    </p>
                    
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-6 mb-3">Prerequisites</h3>
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-6 mb-3">Quick Start</h3>
                    ...
                    <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mt-6">
                      <h4 className="text-lg font-medium text-blue-800 dark:text-blue-300 mb-2">Tip</h4>
                      <p className="text-blue-700 dark:text-blue-400">
                        Start with beginner quests if you&apos;re new to crypto, or check out our tutorials section for guided walkthroughs.
                      </p>
                    </div>
                  </div>
                )}
                ...
                {activeSection === 'creating-quests' && (
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Creating Quests</h2>
                    <p className="mb-4 text-gray-700 dark:text-gray-300">
                      Learn how to create engaging educational quests for your project.
                    </p>
                    
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-6 mb-3">Quest Structure</h3>
                    <p className="mb-4 text-gray-700 dark:text-gray-300">
                ...
                {activeSection === 'rewards' && (
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Setting Up Rewards</h2>
                    <p className="mb-4 text-gray-700 dark:text-gray-300">
                ...
                {activeSection === 'verification' && (
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Verification Methods</h2>
                    <p className="mb-4 text-gray-700 dark:text-gray-300">
                ...
                {activeSection === 'sdk' && (
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">SDK Integration</h2>
                    <p className="mb-4 text-gray-700 dark:text-gray-300">
