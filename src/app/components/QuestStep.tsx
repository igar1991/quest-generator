...
const QuestStep: React.FC<QuestStepProps> = ({ step, onComplete }) => {
  ...
  return (
    <div className="bg-white dark:bg-dark-100 rounded-xl shadow-md p-6 w-full max-w-lg mx-auto">
      ...
      {step.id === '1-2' && (
        <div className="mb-4">
          <label htmlFor="aptosAddress" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
            Your Aptos Address
          </label>
          <input
            type="text"
      ...
      {step.id !== '1-2' && (
        <div className="mb-4">
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-2">
            Complete this task in your wallet or on the specified platform, then mark as complete.
          </p>
          <div className="flex items-center">
            ...
            />
            <label htmlFor="complete" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
